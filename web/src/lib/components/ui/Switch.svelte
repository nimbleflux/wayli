...
<button
	...
	class="relative inline-flex {classes.container} flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-[rgb(34,51,95)] focus:ring-offset-2 focus:outline-none dark:focus:ring-offset-gray-900 {checked
		? 'bg-primary'
